...
<div x-cloak x-show="{{ $modal }}" x-transition.opacity
    ...
    <div x-transition class="relative bg-white rounded-2xl border border-gray-200 shadow-sm w-full max-w-sm p-1 m-2">
        <div class="relative border border-gray-100 rounded-2xl">
            ...
            <div class="p-6 text-center">
                ...
                <p class="text-gray-700 text-sm mt-2 font-semibold">"<span x-text="{{ $name }}"></span>"</p>
            </div>
